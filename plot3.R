# plot3.R. This script will perform the following:
...
# 4. Generate Plot 3 - Energy Sub Metering Plot
# 5. Create output file plot3.png
...
# Generate Plot 3 - Energy Sub Metering Plot
par(mfrow = c(1, 1))
with(DT, 
{
